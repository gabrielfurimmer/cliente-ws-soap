 ...
 * generated in the com.gabriel.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _Operacion_QNAME = new QName("http://ws.gabriel.com/", "operacion");
    private final static QName _OperacionResponse_QNAME = new QName("http://ws.gabriel.com/", "operacionResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.gabriel.ws
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://ws.gabriel.com/", name = "operacion")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.gabriel.com/", name = "operacionResponse")
